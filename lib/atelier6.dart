...
class _Atelier6PageState extends State<Atelier6Page> {
              ...
              children: [
                ListTile(
                  leading: ClipRRect(
                    ...
                    child: Image.asset(product.image, width: 55, height: 55, fit: BoxFit.cover),
                  ),
  ...
  Widget _spec(String label, String value) {
    return Padding(
      ...
      child: Text("$label : $value", style: const TextStyle(color: Colors.black54)),
    );
  }
}
...
class PanierPage extends StatefulWidget {
  ...
  const PanierPage({ required this.cart});
